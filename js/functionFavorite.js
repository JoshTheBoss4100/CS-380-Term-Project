function DisplayAllBooksFavorite(){
...
function DisplayRomanceBooks(){
    document.getElementById("shop_div").innerHTML = "";
    for (book in bookData){
        if(bookData[book].book.genre == "Romance" && bookData[book].favorite == true){
            document.getElementById("shop_div").innerHTML += `<img src="${bookData[book].book.choice.softcover.image}" alt="${bookData[book].book.title}">`;
        }
    }
}
...
function DisplayHistoricalFiction(){
    document.getElementById("shop_div").innerHTML = "";
    for (book in bookData){
        if(bookData[book].book.genre == "Historical Fiction" && bookData[book].favorite == true){
            document.getElementById("shop_div").innerHTML += `<img src="${bookData[book].book.choice.softcover.image}" alt="${bookData[book].book.title}">`;
        }
    }
}
...
function DisplayFantasy(){
    document.getElementById("shop_div").innerHTML = "";
    for (book in bookData){
        if(bookData[book].book.genre == "Fantasy" && bookData[book].favorite == true){
            document.getElementById("shop_div").innerHTML += `<img src="${bookData[book].book.choice.softcover.image}" alt="${bookData[book].book.title}">`;
        }
    }
}
...
function DisplayMystery(){
    document.getElementById("shop_div").innerHTML = "";
    for (book in bookData){
        if(bookData[book].book.genre == "Mystery" && bookData[book].favorite == true){
            document.getElementById("shop_div").innerHTML += `<img src="${bookData[book].book.choice.softcover.image}" alt="${bookData[book].book.title}">`;
        }
    }
}
